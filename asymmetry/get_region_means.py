...
def get_region_means_from_merged_mean_images(syndrome):
    ...
    outfile_path = '/data/mridata/ejkim/EJ/AN_Project/VBM/unionmaps_raw/brainnetome_region_means/%s_raw_mean_region_means.txt' % syndrome

    mean_atrophy_map_path = '/data/mridata/ejkim/EJ/AN_Project/VBM/unionmaps_raw/%s_raw_mean.nii' % syndrome
    ...
    for i in range(1, 247):
        ...
        with open(outfile_path, 'a') as fout:
            fout.write(str(region_mean_value))
            fout.write('\n')
